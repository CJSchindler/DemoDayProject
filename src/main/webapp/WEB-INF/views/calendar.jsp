...
<body>
	...
	<table class="table table-hover">
		...
		<tbody>
			...
			<tr class="table-primary">
				...
				<td rowspan="3">Column content</td>
				<td rowspan="3">Column content</td>
				<td rowspan="3">Column content</td>
			</tr>
		</tbody>
	...
	<form action="/display" method="post">
		<label></label><input type="radio" name="searchType" value="favorites">
		Search Favorites</label> <label></label><input type="radio" name="searchType"
			value="new">Search new recipes</label>
